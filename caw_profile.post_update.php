 ...
 */
function caw_profile_post_update_event_pages() {
  $node_storage = \Drupal::entityTypeManager()->getStorage('node');
 ...
 */
function caw_profile_post_update_header_links_block() {
 ...
 * Create new header link block for the active theme.
 */
function caw_profile_post_update_unpublished_site_banner() {
  $theme = \Drupal::config('system.theme')->get('default');
  if (in_array($theme, [
    'caw_theme',
    'stanford_basic',
