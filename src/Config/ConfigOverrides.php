...
namespace Drupal\caw_profile\Config;
 ...
 *
 * @package Drupal\caw_profile\Config
 */
  ...
  public function loadOverrides($names) {
    ...
    if (in_array('system.site', $names)) {
      $overrides['system.site']['page'] = [
        ...
        404 => $this->state->get('caw_profile.404_page'),
        'front' => $this->state->get('caw_profile.front_page'),
      ];
    }
