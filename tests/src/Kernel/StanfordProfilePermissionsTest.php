...
namespace Drupal\Tests\caw_profile\Kernel;

use Drupal\KernelTests\KernelTestBase;
use Drupal\layout_builder\Entity\LayoutBuilderEntityViewDisplay;
use Drupal\node\Entity\NodeType;
use Drupal\caw_profile\StanfordProfilePermissions;

/**
 * Class StanfordProfilePermissionsTest.
 *
 * @group caw_profile
 * @coversDefaultClass \Drupal\caw_profile\StanfordProfilePermissions
 */
